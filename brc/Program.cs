...
void CreateMeasurements()
{
    ...
    using StreamWriter outFile = new StreamWriter("D:\\repos\\brc\\brc\\measurement.txt");

    if (File.Exists("D:\\repos\\brc\\brc\\measurement.txt"))
    {
        return;
    }
    ...
    {
        var station = stations[randomValue.Next(0, stations.Count)];
        outFile.WriteLine($"{station.Id};{station.Measurement()}");
    }
}
